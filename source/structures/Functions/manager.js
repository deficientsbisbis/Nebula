...
async function prevclear(userId) {
    const response = await axios.post(`${config_api.nebula.panel}/prevname/clear`, {
        userId: userId,
    }, {
        headers: {
            'api-Key': config_api.nebula.api
        }
...
async function prevget(userId) {
    const response = await axios.post(`${config_api.nebula.panel}/prevname/get`, {
        userId: userId,
    }, {
        headers: {
            'api-key': config_api.nebula.api
...
async function prevadd(userId, prevname) {
    const response = await axios.post(`${config_api.nebula.panel}/prevname/add`, {
        prevname: prevname,
        userId: userId,
    }, {
        headers: {
...
async function prevcount() {
    const response = await axios.post(`${config_api.nebula.panel}/prevname/count`, null, {
        headers: {
